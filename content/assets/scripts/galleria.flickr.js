...
F.prototype = {
    ...
    function infoFormat(photo) {
      return photo.title+'<a class="flickr_link" href="http://www.flickr.com/photos/rosic/'+photo.id+'/in/photostream"> - see it on Flickr</a>';
    }
		...
		return this._call(params, function(data) {
          ...
          var item = {
    				...
    				image: img,
    				title: infoFormat(photos[i]), //photos[i].title,
    				description: this.options.description && photos[i].description ? photos[i].description._content : '',
            //link: '<a href="http://http://www.flickr.com/photos/rosic/'+photos[i].id+'/in/photostream">On Flickr</a>'
    			};
